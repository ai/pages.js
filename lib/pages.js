...
;(function($) {
  ...
  window.Pages = {
    ...
    init: function() {
      ...
      this.current = $(this.pagesSelector + ':visible', this._document);
    },
    ...
    // API to wait previous animation, before start new one.
    //
    ...
    //  }
    page: function(url) {
      return $(this.pagesSelector + '[data-url="' + url + '"]', this._document);
    },
