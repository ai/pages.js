  ...
  window.Pages = {
    ...
    open: function(url, data) {
      ...
      if ( page.length ) {
        ...
        var body = $('body', Pages._document).addClass('pages-loading');
        body.trigger('pages-loading', data);
        if ( data.link ) {
          data.link.addClass('pages-loading');
          data.link.trigger('pages-loading', data);
        }
        ...
        this.load(url, data, function(html) {
          ...
          body.removeClass('pages-loading');
          body.trigger('pages-loading-finish', data);
          if ( data.link ) {
            data.link.removeClass('pages-loading');
            data.link.trigger('pages-loading-finish', data);
          }
